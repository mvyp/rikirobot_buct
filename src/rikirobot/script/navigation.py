...
class NavTest():  
    def __init__(self):  
        ...
        locations['p1'] = Pose(Point(3.43, 1.75, 0.000), Quaternion(0, 0, 0,  0))  
        locations['p2'] = Pose(Point(2.75, 5.23, 0.0), Quaternion(0, 0,0, 0)) 
        locations['p3'] = Pose(Point(8.1, 2.07, 0.0), Quaternion(0, 0, 0, 0)) 
        locations['p4'] = Pose(Point(6.11, 5.32, 0.000), Quaternion(0, 0, 0, 0))  
