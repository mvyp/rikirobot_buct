...
class Follower():
    def __init__(self):
        ...
        self.slow_down_factor = rospy.get_param("~slow_down_factor", 0.4)
        ...
        self.depth_subscriber = rospy.Subscriber('search_cloud', PointCloud2, self.set_cmd_vel, queue_size=1)
